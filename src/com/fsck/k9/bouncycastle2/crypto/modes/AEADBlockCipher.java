 ...
 * @see com.fsck.k9.bouncycastle2.crypto.params.AEADParameters
 */
public interface AEADBlockCipher
{
     ...
     * @throws com.fsck.k9.bouncycastle2.crypto.InvalidCipherTextException if the MAC fails to match.
     */
