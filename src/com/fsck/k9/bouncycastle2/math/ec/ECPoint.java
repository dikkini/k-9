package com.fsck.k9.bouncycastle2.math.ec;
...
//        }
    ...
    public static class F2m extends ECPoint
    {
        ...
        /* (non-Javadoc)
         * @see com.fsck.k9.bouncycastle2.math.ec.ECPoint#getEncoded()
         */
        public byte[] getEncoded()
        {
            if (this.isInfinity()) 
...
//            ECFieldElement.F2m.checkFieldElements(a.x, b.x);
        ...
        /* (non-Javadoc)
         * @see com.fsck.k9.bouncycastle2.math.ec.ECPoint#add(com.fsck.k9.bouncycastle2.math.ec.ECPoint)
         */
        public ECPoint add(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see com.fsck.k9.bouncycastle2.math.ec.ECPoint#subtract(com.fsck.k9.bouncycastle2.math.ec.ECPoint)
         */
        public ECPoint subtract(ECPoint b)
        {
            checkPoints(this, b);
        ...
        /* (non-Javadoc)
         * @see com.fsck.k9.bouncycastle2.math.ec.ECPoint#twice()
         */
        public ECPoint twice()
        {
            if (this.isInfinity()) 
