...
public class EC5Util
{
    ...
    public static com.fsck.k9.bouncycastle2.jce.spec.ECParameterSpec convertSpec(
        ECParameterSpec ecSpec,
        boolean withCompression)
    {
        ECCurve curve = convertCurve(ecSpec.getCurve());

        return new com.fsck.k9.bouncycastle2.jce.spec.ECParameterSpec(
            curve,
    ...
    public static com.fsck.k9.bouncycastle2.math.ec.ECPoint convertPoint(
        ECParameterSpec ecSpec,
        ECPoint point,
        boolean withCompression)
    {
